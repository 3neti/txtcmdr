...
import { MessageSquare, Users, Clock, BarChart3 } from 'lucide-vue-next';
...
const features = [
    {
        icon: MessageSquare,
        title: 'Broadcast SMS',
        description: 'Send messages to individuals, groups, or bulk recipients instantly',
    },
    {
        icon: Users,
    ...
    },
    {
        ...
        description: 'Schedule SMS for future delivery with flexible timing options',
    },
    {
        icon: BarChart3,
        title: 'Track Results',
        description: 'Monitor message delivery with comprehensive analytics and history',
    },
];
</script>
...
<template>
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
        <!-- Header -->
        <header class="border-b border-slate-200 bg-white/50 backdrop-blur-sm dark:border-slate-800 dark:bg-slate-950/50">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
                <div class="flex items-center gap-2">
                    <MessageSquare class="h-8 w-8 text-blue-600 dark:text-blue-400" :stroke-width="2" />
                    <span class="text-xl font-bold text-slate-900 dark:text-slate-100">Text Commander</span>
                </div>
        ...
        <main class="mx-auto max-w-7xl px-6 py-16 sm:py-24">
            <div class="text-center">
                ...
                <p class="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
                    Send targeted messages to groups of contacts with ease. Manage contacts, schedule messages, and track delivery—all in one powerful platform.
                </p>
            ...
            <div class="mx-auto mt-24 max-w-5xl">
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    >
                        <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-600/10">
                            <component :is="feature.icon" class="h-6 w-6 text-blue-600 dark:text-blue-400" :stroke-width="2" />
                        </div>
        ...
        <footer class="mt-auto border-t border-slate-200 py-6 dark:border-slate-800">
            <div class="mx-auto max-w-7xl px-6 text-center text-sm text-slate-600 dark:text-slate-400">
                <p>© {{ new Date().getFullYear() }} Text Commander. Built with Laravel & Vue.</p>
            </div>
        </footer>
    </div>
</template>
